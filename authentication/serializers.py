...
class RegistrationSerializer(serializers.ModelSerializer):
    firstName = serializers.CharField(max_length=256,required=False)
    lastName = serializers.CharField(max_length=256,required=False)
    ...
    class Meta:
        model = User
        fields = ['email','firstName','lastName','password','token']
