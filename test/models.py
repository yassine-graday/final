...
class Test(TimeStampedModel):
    ...
    question21 = models.CharField(max_length=255,blank=True,null=True)
    question22 = models.CharField(max_length=255,blank=True,null=True)
    question23 = models.CharField(max_length=255,blank=True,null=True)
    question24 = models.CharField(max_length=255,blank=True,null=True)
    question25 = models.CharField(max_length=255,blank=True,null=True)
    question26 = models.CharField(max_length=255,blank=True,null=True)
    question27 = models.CharField(max_length=255,blank=True,null=True)
    question28 = models.CharField(max_length=255,blank=True,null=True)
    question29 = models.CharField(max_length=255,blank=True,null=True)
    question30 = models.CharField(max_length=255,blank=True,null=True)
    question31 = models.CharField(max_length=255,blank=True,null=True)
    question32 = models.CharField(max_length=255,blank=True,null=True)
    question33 = models.CharField(max_length=255,blank=True,null=True)
    question34 = models.CharField(max_length=255,blank=True,null=True)
    question35 = models.CharField(max_length=255,blank=True,null=True)
    question36 = models.CharField(max_length=255,blank=True,null=True)
    question37 = models.CharField(max_length=255,blank=True,null=True)
    question38 = models.CharField(max_length=255,blank=True,null=True)
    question39 = models.CharField(max_length=255,blank=True,null=True)
    question40 = models.CharField(max_length=255,blank=True,null=True)
    question41 = models.CharField(max_length=255,blank=True,null=True)
    question42 = models.CharField(max_length=255,blank=True,null=True)
    question43 = models.CharField(max_length=255,blank=True,null=True)
    question44 = models.CharField(max_length=255,blank=True,null=True)
...
class Resultparam(models.Model):
    name = models.CharField(max_length=255, blank= True, null= True)
    image_question = models.ImageField(upload_to='staticfiles/assets/images/questions/',max_length=512,blank=True, null=True)
